...
class Search implements SearchProviderInterface
{
    ...
    {
        return $this->getActiveProvider()->createDocument($uid, $document, $this->indexNamePrefix . $indexName, $indexType);
    }
    ...
    {
        return $this->getActiveProvider()->addDocument($this->indexNamePrefix . $indexName, $indexType, $document, $uid);
    }
